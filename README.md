...
- New callout
    * Name: CName
    * Package: net.frontuari.theme.callout
    * Example: net.frontuari.theme.callout.CStringFormat

- New process
    * Name: PName
    * Package: net.frontuari.theme.process
    * Example: net.frontuari.theme.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: net.frontuari.theme.form
    * Example: net.frontuari.theme.form.FMultiPayment

- New event
    * Name: EName
    * Package: net.frontuari.theme.event
    * Example: net.frontuari.theme.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: net.frontuari.theme.model
    * Example: net.frontuari.theme.model.MTableExample
...
- New callout
    * Create callout in package `net.frontuari.theme.callout`, extends from `CustomCallout`
    * Annotate it with the `@Callout` annotation at class level

- New process
    * Create process in package `net.frontuari.theme.process`, extends from `CustomProcess`
    * Annotate it with the `@Process` annotation at class level

- New form
    * Create form in package `net.frontuari.theme.form`, extends from `CustomForm`
    * Annotate it with the `@Form` annotation at class level

- New event
    * Create event in package `net.frontuari.theme.event`, extends from `CustomEvent`
    * Annotate it with the `@EventTopicDelegate` annotation at class level

- New model (extends form class X)
    * Create model in package `net.frontuari.theme.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
